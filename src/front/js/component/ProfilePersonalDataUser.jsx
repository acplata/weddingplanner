                ...
                <div className="profile-layout1 mt-2">
                    <div className="card-body">
                        ...
                        <ul className="list-group list-group-flush mt-3">
                            <li className="list-group-item border-top border-bottom border-warning-subtle"><b>Novia & Novio:</b> {store.weddingData?.name_novia} & {store.weddingData?.name_novio} </li>
                            <li className="list-group-item border-warning-subtle "><b>Fecha:</b> {store.weddingData?.wedding_date}</li>
                            <li className="list-group-item border-warning-subtle"><b>Lugar:</b> {store.weddingData?.place}</li>
                        </ul>
